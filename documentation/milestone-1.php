...
<html lang="en">
	...
	<body>
		...
		<section>
			<h3>Goal:</h3>
			<p>
				The goal of my project is to allow me to get my foot in the door of the tech industry.
				I want to have something tangible to present to my future employers and clients which
				will demonstrate my technical abilities in the area of front-end and back-end development.
			</p>
		</section>
	</body>
</html>